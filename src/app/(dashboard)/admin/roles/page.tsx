          ...
          {roles?.map((role: Role) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group relative bg-[#050508]/80 backdrop-blur-3xl border border-white/5 rounded-[3rem] p-10 flex flex-col h-full overflow-hidden"
              >
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="p-3 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl text-white/40 hover:text-white transition-all active:scale-95"
                    >
                      <Edit2 size={14} />
                    </button>
                ...
                <p className="text-[11px] font-medium text-white/60 mb-10 italic leading-loose tracking-wide relative z-10 px-1 border-l border-white/10 ml-1">
                      ...
                      Object.entries(groupedPerms).map(([category, perms]: [string, any]) => (
                        <div key={category} className="space-y-3">
                          <div className="flex items-center gap-2 px-2">
                            <div className="text-indigo-500/60 uppercase">
                            ...
                            {perms.map((perm: any) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={cn(
                                    'w-full px-6 py-4 rounded-2xl border flex items-center justify-between transition-all active:scale-[0.97] group/item relative overflow-hidden',
                                    isAssigned
                                  ...
                                  <div className="text-left relative z-10">
                                    ...
                                    <p
                                      className={cn(
                                        ...
                                        isAssigned ? 'text-white/70' : 'text-white/20'
                                      )}
                                    >
                                  ...
                                  <div
                                    className={cn(
                                      ...
                                      isAssigned
                                        ...
                                        : 'bg-white/5 border border-white/5 text-white/5 group-hover/item:border-white/20 group-hover/item:text-white/40'
                                    )}
                                  >
                                    {isAssigned ? (
                                      <CheckCircle2
          ...
          {(isCreateModalOpen || isEditModalOpen) && (
            <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
              ...
              >
                ...
                >
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-indigo-600/60 dark:text-indigo-400/60 uppercase tracking-widest pl-1">

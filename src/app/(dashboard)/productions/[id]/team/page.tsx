...
import {
  ...
  useAssignUser,
  useRemoveUser,
} from '@/features/productions/hooks/useProductions';
            ...
            <div className="bg-card-bg border border-card-border rounded-2xl overflow-hidden ">
              ...
              <ul className="divide-y divide-card-border/50">
                {((production as any).users || []).map((prodUser: any) => (
                  <li
                    key={prodUser.userId}
                    className="p-4 hover:bg-card-border/30 transition-colors flex flex-col gap-4 md:flex-row md:items-center justify-between group"
                  >
                    <div className="flex  items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-foreground font-medium text-sm">
                          {prodUser.user.name || 'Unnamed User'}
                        </h4>

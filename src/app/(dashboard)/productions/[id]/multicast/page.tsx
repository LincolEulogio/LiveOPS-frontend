                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <h2 className="text-[10px] font-black text-muted-foreground uppercase tracking-widest leading-none">Signal Distribution</h2>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="text-sm font-medium text-muted-foreground/60">Dashboard</span>
                            <span className="text-white/20">/</span>
                            <span className="text-sm font-black text-white uppercase italic">Multi-Cast Control</span>
                        </div>
                    </div>
                </div>

                <div className="hidden lg:flex items-center gap-3 px-6 py-3 bg-red-600/10 border border-red-500/20 rounded-2xl">
                    <Zap size={14} className="text-red-500 animate-pulse" />
                    <span className="text-[10px] font-black text-red-500 uppercase tracking-widest">Master Feed: OFFLINE</span>
                </div>
            </div>

            <div className="bg-[#050508]/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-8 overflow-hidden min-h-[600px]">
                <MulticastManager productionId={id} />
            </div>
        </div>
    );
}

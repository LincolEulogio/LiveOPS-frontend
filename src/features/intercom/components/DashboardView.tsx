...
export const DashboardView = () => {
    ...
    return (
        <div className="space-y-8 max-w-[1800px] mx-auto pb-20 mt-2 sm:mt-4">
            ...
            <div className="bg-card-bg/60 backdrop-blur-3xl border border-card-border rounded-[2.5rem] p-6 md:p-10 flex flex-col min-[1100px]:flex-row items-center justify-between gap-8 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] relative overflow-hidden group">
                {/* Tactical Scanline */}
                ...
                <div className="flex items-center gap-6 w-full min-[1100px]:w-auto relative z-10">
                    <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-indigo-600/20 border border-indigo-400/20 group-hover:rotate-3 transition-transform">
            ...
            <div className="flex flex-col min-[1280px]:flex-row gap-6 items-start min-[1280px]:items-center">
                <div className="flex bg-card-bg/40 backdrop-blur-xl p-1.5 rounded-[1.5rem] border border-card-border w-full xl:w-auto overflow-x-auto no-scrollbar gap-1 shadow-inner">
                    {[
            ...
            <div className="grid grid-cols-1 min-[1280px]:grid-cols-12 gap-8 items-start">
                    ...
                    <AnimatePresence mode="wait">
                        {activeTab === 'intercom' ? (
                            ...
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -20 }}
                            >
                                <div className="bg-card-bg/60 backdrop-blur-2xl border border-card-border rounded-[3rem] p-8 md:p-12 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] min-h-[500px]">
                ...
                <div className="min-[1280px]:col-span-4 min-[1440px]:col-span-3 space-y-8 flex flex-col h-fit min-[1280px]:sticky min-[1280px]:top-8 pb-10">
                    ...
                    <div className="bg-card-bg/60 backdrop-blur-2xl border border-card-border rounded-[3rem] overflow-hidden shadow-2xl flex flex-col h-[450px] sm:h-[500px] group/rundown relative">
                    ...
                    <div className="bg-card-bg/60 backdrop-blur-2xl border border-card-border rounded-[3rem] flex flex-col shadow-2xl overflow-hidden h-[400px] min-[1440px]:h-[450px] relative">
                    ...
                    <div className="hover:scale-[1.02] transition-transform duration-500 shadow-2xl rounded-[3rem]">

...
export function StreamingDashboard({ productionId, engineType }: StreamingDashboardProps) {
    ...
    if (isLoading) {
        return (
            <div className="bg-card-bg border border-card-border rounded-2xl p-12 flex flex-col items-center justify-center space-y-4">
                <Loader2 className="animate-spin text-indigo-500" size={32} />
                <p className="text-muted text-sm">Connecting to engine...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-card-bg border border-card-border rounded-xl p-4 flex items-center justify-between shadow-lg">
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-medium text-muted uppercase tracking-wider">Gateway</span>
                    </div>

                    <div className="flex items-center gap-2 border-l border-card-border pl-6">
                        {isEngineConnected ? (
            ...
            <div className="bg-card-bg border border-card-border rounded-2xl overflow-hidden shadow-2xl">
                <div className="p-1 px-6 bg-card-border/30 border-b border-card-border">
                    <h2 className="text-xs font-bold text-muted uppercase tracking-widest py-3">Live Controls</h2>
                </div>

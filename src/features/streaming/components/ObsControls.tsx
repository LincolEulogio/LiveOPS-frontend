        ...
        return (
            <div className="flex flex-col items-center justify-center p-8 text-center space-y-3">
                ...
                <div className="space-y-1">
                    <h3 className="text-muted font-semibold">OBS Disconnected</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-2 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    {!state?.scenes?.length && (
                        <p className="text-muted text-xs italic p-4 text-center border border-dashed border-card-border rounded-xl">
            ...
            <div className="space-y-6">
                ...
                {/* Stats placeholder */}
                <div className="bg-background border border-card-border rounded-xl p-4 grid grid-cols-2 gap-4">
                    <div>
                        <p className="text-[10px] font-bold text-muted uppercase tracking-widest mb-1">FPS</p>
                        <p className="text-xl font-mono text-foreground">{state?.fps || '--'}</p>
                    </div>
                    <div>
                        <p className="text-[10px] font-bold text-muted uppercase tracking-widest mb-1">CPU</p>
                        <p className="text-xl font-mono text-foreground">{state?.cpuUsage?.toFixed(1) || '--'}%</p>
                    </div>
                </div>
            </div>
        </div>

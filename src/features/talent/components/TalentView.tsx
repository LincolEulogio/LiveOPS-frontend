                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center py-10">
                            ...
                            <div className="mt-12 scale-150 md:scale-[2.5]">
                                <BigTimer startTime={activeBlock.startTime ?? null} durationMs={activeBlock.durationMs ?? 0} />
                            </div>
                        </div>
...
const BigTimer = ({ startTime, durationMs }: { startTime: string | null; durationMs: number }) => {
    ...
    return (
        <div className={cn(
            ...
            isOver ? "text-red-500 animate-pulse" : remaining < 30000 ? "text-amber-400" : "text-emerald-400"
        )}>

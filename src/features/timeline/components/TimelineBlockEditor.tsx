...
export const TimelineBlockEditor = ({ isOpen, onClose, onSave, editingBlock }: Props) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-lg bg-stone-900 border border-stone-800 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300 flex flex-col">
                {/* Header */}
                <div className="flex items-center justify-between p-6 border-b border-stone-800 bg-stone-900/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-stone-500">Configure block details and automations.</p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit(onSave)} className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-stone-400 uppercase tracking-widest pl-1 flex items-center gap-2">
                            <Type size={12} />
                            Segment Title
                        </label>
                        <input
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-stone-950 border border-stone-800 rounded-2xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all"
                            />
                        </div>
                    ...
                    {/* Notes */}
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-stone-400 uppercase tracking-widest pl-1">Internal Production Notes</label>
                        <textarea
                            {...register('notes')}
                            rows={3}
                            placeholder="Add tips for the operator or script cues..."
                            className="w-full bg-stone-950 border border-stone-800 rounded-2xl px-4 py-3 text-white placeholder:text-stone-700 focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all resize-none"
                        />
                    </div>
                </form>
